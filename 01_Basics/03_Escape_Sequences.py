...
print('Hello World.\nCurrently I am currenly working in Wipro.')     # "\n" we used for new line
print("My CTC is \t\t\t jane do chodo.")    # "\t" we used for TAB
print ("I travel to office by \"Bus\" or with \'Frinds\'.")     # "\'" and "\"" is used when we want double quotes in line
print('My manager is M\\adarC\\hod')   
