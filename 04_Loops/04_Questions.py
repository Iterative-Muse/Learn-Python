...
# print(f"There are total {div_6} number which is divisible by 6 and total {div_7} number which is divisible by 7 and {div_6and7} number which is divisible by both.")
